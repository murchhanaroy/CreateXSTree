...
! radlen is total radiation length (real radlen + internal radiation(2~5%)
! internal radlen should be calculated outside and add into this parameter)
! XSEC is the output cross section in nbarn/GeV/sr, per nucleon
! convert to ub/MeV*str in the routine
