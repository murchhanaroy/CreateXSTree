...
#ifdef ReadHMS_cxx
ReadHMS::ReadHMS(const char* filename)
{
  ...
  TTree* tree = (TTree*)gDirectory->Get("h1");
...
Int_t ReadHMS::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t ReadHMS::LoadTree(Long64_t entry)
{
...
void ReadHMS::Show(Long64_t entry)
{
...
Int_t ReadHMS::Cut(Long64_t entry)
{
