...
#define SHMSXSTree_Debug 4
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
class SHMSXSTree:ReadSHMS
{
public:
    SHMSXSTree(const char* filename);
    virtual ~SHMSXSTree();
...
public:
    void SetTreeLevel(int pLevel) {mTreeLevel=pLevel;cout<<"Update SHMSXSTree::mTreeLevel to "<<mTreeLevel<<endl; };
